...
<head>
	...
	<link rel="stylesheet" href="js/magnific-popup/dist/magnific-popup.css" type="text/css" media="all">
...
<div class="site-wrapper">
	...
	<div class="mobile-header py-2 px-3 mt-4">
		...
		<a href="index.html" class="logo"><img src="images/duwicircle.png" alt="Duwi" /></a>
	...
	<header class="left float-left shadow-dark" style="background: #5C72EA" id="header">
		...
		<div class="header-inner d-flex align-items-start flex-column ">
			...
			<span class="site-slogan">PHP Programer</span>
			...
			<nav>
				<ul class="vertical-menu scrollspy" style="margin-bottom: 20px">
					...
					<li><a href="#testimonials" onclick="aktif(this)" class="tombol"><i class="icon-bulb"></i>Testimoni</a></li>					
	...
	<main class="content float-right">
		...
		<section class="hero background parallax shadow-dark d-flex align-items-center" id="home" data-image-src="images/background2.jpg">
			<div class="cta mx-auto mt-2">
				...
				<div class="scrollspy">
					<a href="#works" class="btn btn-default btn-lg mr-3"><i class="icon-grid"></i>Lihat Portfolio</a>
					<div class="spacer d-md-none d-lg-none d-sm-none" data-height="10"></div>
					<a href="#contact" class="btn btn-border-light btn-lg"><i class="icon-envelope"></i>Kerjasama</a>
				</div>	
			</div>
		...
		<section id="works" class="shadow-blue white-bg padding">
			...
			<div class="row portfolio-wrapper">
				...
				<div class="col-md-4 col-sm-6 grid-item backend premium">
					<a class="image-popup-vertical-fit el-link" href="images/portofolio/appstackipad.jpg">
				...
				<div class="col-md-4 col-sm-6 grid-item freedownload">
					<a class="image-popup-vertical-fit el-link" href="images/portofolio/manajemenproyek.jpg">
						<div class="portfolio-item">
							<div class="details">
				...
				<!-- portfolio item -->
				<div class="col-md-4 col-sm-6 grid-item backend premium">
					<a class="image-popup-vertical-fit el-link" href="images/portofolio/erpdashboard.jpg">
						<div class="portfolio-item">
							<div class="details">
				...
				<div class="col-md-4 col-sm-6 grid-item premium">
					<a class="image-popup-vertical-fit el-link" href="images/portofolio/portalweddingjogja.jpg">
						<div class="portfolio-item">
							<div class="details">
				...
				<!-- portfolio item -->
				<div class="col-md-4 col-sm-6 grid-item premium">
					<a class="image-popup-vertical-fit el-link" href="images/portofolio/rtlhipad.jpg">
						<div class="portfolio-item">
							<div class="details">
								<h4 class="title">Permohonan Hunian</h4>
								<span class="term">Permohonan Bantuan Hunian Kab.Sleman</span>
							</div>
							<span class="plus-icon">+</span>
							<div class="thumb">
				...
				<div class="col-md-4 col-sm-6 grid-item frontend freedownload">
					<a class="image-popup-vertical-fit el-link" href="images/portofolio/pendaftaranwisuda.jpg">
						<div class="portfolio-item">
							<div class="details">
								<h4 class="title">Pendaftaran Wisuda</h4>
								<span class="term">Pendaftaran Wisuda Berbasis Web</span>
							</div>
							<span class="plus-icon">+</span>
							<div class="thumb">
				...
				<div class="col-md-4 col-sm-6 grid-item premium backend">
					<a class="image-popup-vertical-fit el-link" href="images/portofolio/manajemenproyekdashboard.jpg">
						<div class="portfolio-item">
							<div class="details">
				...
				<!-- portfolio item -->
				<div class="col-md-4 col-sm-6 grid-item backend premium">
					<a class="image-popup-vertical-fit el-link" href="images/portofolio/appstackmac.jpg">
						<div class="portfolio-item">
							<div class="details">
				...
				<!-- portfolio item -->
				<div class="col-md-4 col-sm-6 grid-item premium">
					<a class="image-popup-vertical-fit el-link" href="images/portofolio/admindek.jpg">
						<div class="portfolio-item">
							<div class="details">
				...
				<!-- portfolio item -->
				<div class="col-md-4 col-sm-6 grid-item premium">
					<a class="image-popup-vertical-fit el-link" href="images/portofolio/gismasjid.jpg">
						<div class="portfolio-item">
							<div class="details">
								<h4 class="title">Gis Masjid</h4>
								<span class="term">Aplikasi Pemetaan Masjid</span>
							</div>
							<span class="plus-icon">+</span>
							<div class="thumb">
				...
				<!-- portfolio item -->
				<div class="col-md-4 col-sm-6 grid-item premium">
					<a class="image-popup-vertical-fit el-link" href="images/portofolio/extemeadmin.jpg">
						<div class="portfolio-item">
							<div class="details">
								<h4 class="title">CRM</h4>
								<span class="term">Backend</span>
		...
		<!-- section clients -->
		<section id="clients" class="shadow-dark  padding-50">

			<!--  background-blue hidden heading for validation -->
			<h3 class="section-title">Klien</h3>
			<div class="spacer" data-height="50"></div>
			...
			<div class="clients-wrapper row">
				...
				<div class="col-md-3">
					...
					<div class="client-item">
						<div>
							<img src="images/client/istakprind.png" width="120px" height="120px" alt="Institut Sains & Teknologi AKPRIND" />
						</div>
					</div>
				</div>
				...
				<div class="col-md-3">
					...
					<div class="client-item">
						<div >
							<img src="images/client/logounjani.jpg" width="120px" height="120px" alt="Universitas Achmad Yani Yogyakarta" />
						</div>
					</div>
				</div>
				...
				<div class="col-md-3">
					...
					<div class="client-item">
						<div class="">
							<img src="images/client/sleman.jpg" width="120px" height="120px" alt="Kab.Sleman" />
						</div>
					</div>
				</div>
				...
				<div class="col-md-3">
					...
					<div class="client-item">
						<div class="">
							<img src="images/client/lpp.png"   alt="LPP Yogyakarta" />
						</div>
					</div>
				</div>
				...
				<div class="col-md-3">
					...
					<div class="client-item">
						<div class="">
							<img src="images/client/logorsuii.png" width="120px" height="120px" alt="RSUII" />
						</div>
					</div>
				</div>
...
<script src="js/magnific-popup/meg.init.js"></script>
</body>
</html>
